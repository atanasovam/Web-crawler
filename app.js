...
const pageLinksSelectorSmartphonebg = '.products li article div:not([class]) a';
...
(async () => {
    ...
    const smartphonebgPhones =
        await extractPagesUrls(smartphonebgUrl, pageLinksSelectorSmartphonebg);

    const technomarketPhoneDetails =
        await extractPhoneDetailsS(smartphonebgPhones);
})();
